...
hardware = graphic.add(Image("../models/20-pin-keyed.svg", width=180, height=360, embed=True))

hardware.add_coord("p20", x= 75, y= 45)
hardware.add_coord("p19", x=105, y= 45)
hardware.add_coord("p18", x= 75, y= 75)
hardware.add_coord("p17", x=105, y= 75)
hardware.add_coord("p16", x= 75, y=105)
hardware.add_coord("p15", x=105, y=105)
hardware.add_coord("p14", x= 75, y=135)
hardware.add_coord("p13", x=105, y=135)
hardware.add_coord("p12", x= 75, y=165)
hardware.add_coord("p11", x=105, y=165)
hardware.add_coord("p10", x= 75, y=195)
hardware.add_coord("p9",  x=105, y=195)
hardware.add_coord("p8",  x= 75, y=225)
hardware.add_coord("p7",  x=105, y=225)
hardware.add_coord("p6",  x= 75, y=255)
hardware.add_coord("p5",  x=105, y=255)
hardware.add_coord("p4",  x= 75, y=285)
hardware.add_coord("p3",  x=105, y=285)
hardware.add_coord("p2",  x= 75, y=315)
hardware.add_coord("p1",  x=105, y=315)
hardware.add_coord("pin_pitch_v", x=0, y=30)

graphic.add(
    PinLabelGroup(
        x=hardware.coord("p20").x,
        y=hardware.coord("p20").y,
...
graphic.add(
    PinLabelGroup(
        x=hardware.coord("p19").x,
        y=hardware.coord("p19").y,
        pin_pitch=hardware.coord("pin_pitch_v", raw=True),
        label_start=(60, 0),
        label_pitch=(0, 30),
