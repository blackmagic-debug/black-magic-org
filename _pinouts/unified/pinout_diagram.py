...
diagram = Diagram_2Rows(diagram_width, diagram_height, 300, "diagram")
diagram.add_stylesheet("styles.css", embed=True)

graphic = diagram.panel_01.add(Group((diagram_width - hardware_width) / 2, 50))

hardware = graphic.add(Image("../models/10-pin-keyed.svg", width=hardware_width, height=hardware_height, embed=True))
