...
```
This will result in binary files:<br>
`blackmagic.elf` - ELF binary of the Black Magic debug probe.<br>
`blackmagic.bin` - Flat binary of the Black Magic debug probe, load at `0x8002000`.<br>
`blackmagic_dfu` - ELF binary of the Black Magic DFU bootloader.<br>
`blackmagic_dfu.bin` - Flat binary of the DFU bootloader, load at `0x8000000`.<br>
