...
in most cases will not require to compile anything. We recommend updating the firmware using `bmputil`, however if
you want to use a different tool (`dfu-util`, `stlink-tool`, etc) you can find some instructions for *other*
tools at the end of this document. If you have trouble using `bmputil` please let us know, as we strive to make the
...
The tool should be able to find and list the Black Magic Probe connected to the system. This will look something like
this:
